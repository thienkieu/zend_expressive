...
class ToVerbalDocumentAdapter implements ConvertDTOAToDocumentAdapterInterface {
    protected $container;
    protected $convertor;
    ...
    {
        if ($dtoObject instanceof \Test\DTOs\Question\VerbalQuestionDTO && !isset($options[\Config\AppConstant::ToDocumentClass])) {
            return true;
        }
    ...
    {  
        $document = new \Test\Documents\Question\VerbalQuestionDocument();
