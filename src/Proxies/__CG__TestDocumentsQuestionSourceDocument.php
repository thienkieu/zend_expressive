 ...
 */
class SourceDocument extends \Test\Documents\Question\SourceDocument implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SourceDocument $proxy) {
