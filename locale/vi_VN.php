...
return array(
    ...
    'Source is not exist.' => 'Source %sourceName% does not exist, please check spelling or create the source first!',
    ...
    'There is error with format data, Please check it again' => 'There is an error with format data. Please check it again.',
    ...
    'Field \'%field%\' cannot correct format, Please check it again.' => 'Field \'%field%\' is not in correct format. Please check it again!',
    'Source cannot empty.' => 'Source cannot be empty at line %lineNumber%.', 
    'There is problem with update pin %pin%', 'Please refresh new pin.' => 'There is a problem with update pin \'%pin%\', Please refresh new pin.',
    'Your pin \'%pin%\' is not valid, Please notify to admin to get new pin' => 'Your pin \'%pin%\' is not valid. Please notify to admin to get a new pin.',
    ...
    'Type is not exist.' => 'Type %typeName% at line %lineNumber% does not exist. Please check spelling or create type first!',
    'SubType cannot empty.' => 'Sub-Type cannot be empty at line %lineNumber%.', 
    'SubType is not exist.' => 'Sub-Type %subType% at line %lineNumber% does not exist. Please check spelling or creating sub-type first!',
    ...
    'Source not found at line number %lineNumber%, please check it again.' => 'Source %sourceName% does not exist. Please check spelling or create the source first!',
